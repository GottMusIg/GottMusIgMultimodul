...
public class Target {
     ...
     */
    @JsonProperty("buffs")
    private List<Object> buffs = new ArrayList<Object>();
    /**
     * 
     */
    @JsonProperty("bugs")
