...
public class EffectiveTheckMeloreeIndex {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EffectiveTheckMeloreeIndex) == false) {
            return false;
        }
        EffectiveTheckMeloreeIndex rhs = ((EffectiveTheckMeloreeIndex) other);
