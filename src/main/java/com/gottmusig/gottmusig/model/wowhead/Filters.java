...
public enum Filters {
	...
	Filters(int param1, int param3){
		this.param1 = param1;
		this.param3 = param3;
		//param 2 wird gesetzt wenn der Race_Specific filter oder SpecFilter gebraucht wird
	}
	...
	public Filters setSpec(ClassSpec spec){
		if(this.equals(RACE_SPECIFIC)){
			this.param2 = spec.getId();
		}
		return this;
	}
